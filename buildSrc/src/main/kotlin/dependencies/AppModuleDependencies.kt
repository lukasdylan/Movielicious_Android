...
internal fun Project.configureAppDependencies() = dependencies {
    ...
    add(ConfigurationType.TEST_IMPLEMENTATION, Dependency.MOCKITO_CORE)
    add(ConfigurationType.TEST_IMPLEMENTATION, Dependency.MOCKITO_ANDROID)
    add(ConfigurationType.TEST_IMPLEMENTATION, Dependency.MOCKITO_KOTLIN)
